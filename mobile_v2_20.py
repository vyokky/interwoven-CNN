...
def mobilenet_v2(layer, n_filter, stride=1, filtersize = (filter_shape, filter_shape), name = 'mobile_2', is_train = True, reuse=False, act=tf.nn.relu6, expand_ratio = 6):
...
nf.customfit(sess = sess, network = network, cost = cost, train_op = train_op, tra_provider = tra_provider, x = x, y_ = y_, acc=acc, n_epoch=EPOCH,
              ...
              save_path='/oldhome/s1500945/etri/model/mobile_v2_20', epoch_identifier=None, baseline = 100000)
# sess.close()
